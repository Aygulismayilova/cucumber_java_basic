...
Feature: Introduction to cucumber task2
  ...
  Scenario Outline: edit a person
    ...
    Scenario Outline: Add a person, then reset the list
      Then I click Add person button
      And I enter firstname: "<name>"
      And I enter job: "<job>"
      Then I click Add button
      ...
      Scenario Outline: Edit the person, then reset the list
        Then I click Add person button
        And I enter firstname: "<name>"
        And I enter job: "<job>"
        Then I click Add button
  ...
  @tasktwo
Scenario: delete a person, then reset the list
  Then I click delete button
  And I check the deleted person disappeared from list
  And click reset button
  Then I check the list is correct
    ...
    Scenario Outline: check clear all button on adding a person
      Then I click Add person button
      And I enter firstname: "<name>"
      And I enter job: "<job>"
